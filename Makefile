...
PROJECT_NAME := provider-newrelic
PROJECT_REPO := github.com/BrennenMM7/$(PROJECT_NAME)

export TERRAFORM_VERSION := 1.3.3

export TERRAFORM_PROVIDER_SOURCE := newrelic/terraform-provider-newrelic
...
export TERRAFORM_NATIVE_PROVIDER_BINARY := terraform-provider-newrelicv3.6.1_x5
